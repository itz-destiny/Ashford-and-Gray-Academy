...
// Dedicated monitor accounts run on a phone pinned to this screen — no
// sidebar, just two tabs (Live Classes, Schedule) and a way to sign out.
// An admin using this as their IT dashboard gets extra tabs (User Lookup,
// plus quick links into the other portals) that a plain monitor account
// never sees.
