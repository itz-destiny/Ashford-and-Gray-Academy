...
import { Loader2, Radio, Video, AlertTriangle, MonitorPlay } from "lucide-react";
    ...
    return (
        <div className="flex-1 flex flex-col items-center px-6 py-12 gap-8">
            <div className="space-y-2 text-center">
                ...
                <p className="text-white/50 text-sm">Pick any class below to join and monitor it.</p>
            </div>
            ...
            {classes && classes.length > 0 ? (
                <div className="w-full max-w-2xl space-y-4">
                    {classes.map((cls) => (
                        ...
                        >
                            ...
                            <Button
                                onClick={() => cls.zoomJoinUrl && window.open(cls.zoomJoinUrl, '_blank', 'noopener,noreferrer')}
                                disabled={!cls.zoomJoinUrl}
                ...
                <div className="w-full max-w-md bg-white/[0.03] border border-white/10 p-8 space-y-2 text-center">
                    ...
                    <p className="text-white/70 font-serif text-lg">Nothing is live right now.</p>
