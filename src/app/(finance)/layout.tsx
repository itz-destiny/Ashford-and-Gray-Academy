                        ...
                        <div className="flex items-center gap-3 mb-4">
                            <Avatar>
                                ...
                                <AvatarFallback className="bg-orange-100 text-orange-600">
                                    {user?.displayName ? user.displayName.split(' ').map(n => n[0]).join('') : 'FM'}
                                </AvatarFallback>
                            </Avatar>
                            <div className="overflow-hidden">
                                <p className="font-bold text-sm truncate">{user?.displayName || "Finance Mgr"}</p>
                                <p className="text-xs text-slate-500 truncate capitalize">Finance Manager</p>
                            </div>
                        </div>
                        <Button
                            variant="outline"
