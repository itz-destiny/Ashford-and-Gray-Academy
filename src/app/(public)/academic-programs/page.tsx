    ...
    <div className="bg-[#FAF9F6] min-h-screen text-[#0B1F3A]">
        ...
        <div className="container px-6 lg:px-12 mx-auto relative z-10 text-center max-w-3xl space-y-6">
          ...
          <ScrollAnimation animation="fade-in-up" delay={100}>
            <h1 className="text-4xl md:text-6xl font-serif text-white tracking-tight leading-none">
              Academic <span className="italic text-[#C8A96A]">Programs</span>
            </h1>
          </ScrollAnimation>

          <ScrollAnimation animation="fade-in-up" delay={200}>
            <p className="text-base md:text-lg text-slate-300 leading-relaxed font-semibold">
              Ashford &amp; Gray Fusion Academy offers several distinct educational tracks designed to transform candidates into operational authorities in their fields.
            </p>
          </ScrollAnimation>
        </div>
      </header>

      {/* HBS Screenshot Replica Section */}
      <main className="container px-6 lg:px-12 mx-auto py-24 md:py-32">
        <div className="space-y-12">
          ...
          {/* 4-column Light Blue-Grey HBS Cards */}
            ...
            {pathways.map((path, idx) => (
              <ScrollAnimation key={path.title} animation="fade-in-up" delay={idx * 100}>
                <Link href={path.href} className="group block h-full">
                  <div className="bg-[#B9CEDA]/30 hover:bg-[#B9CEDA]/50 border border-slate-200/50 shadow-sm group-hover:shadow-lg p-10 h-full flex flex-col justify-between items-start text-left min-h-[300px] transition-all duration-300 relative rounded-none">
                    
                    {/* Top Content */}
                    <div className="space-y-4">
                      <span className="text-[#1F7A5A] text-[9px] font-black uppercase tracking-[0.2em] block">
                        {path.badge}
                      </span>
                      <h3 className="text-3xl font-serif font-bold text-[#0B1F3A] leading-none border-b border-slate-200/40 pb-2">
                        {path.title}
                      </h3>
                    ...
                    {/* Bottom Left Simple Arrow (HBS Style) */}
      ...
      <section className="bg-[#0B1F3A] text-white py-16 text-center">
        <div className="container px-6 mx-auto max-w-3xl space-y-6">
          ...
          <p className="text-xs text-slate-400 max-w-md mx-auto leading-relaxed">
            Our academic advisors are available to assist you in aligning your experience with our programs.
          </p>
          <div className="pt-2">
