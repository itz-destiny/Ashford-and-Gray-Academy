...
import {
    ...
    LayoutDashboard, LogOut, History, Sparkles, PlayCircle, ClipboardCheck, Star, Link2,
} from "lucide-react";
...
const navItems = [
    ...
    { href: "/registrar/zoom-links",     label: "Zoom Links",      icon: Link2 },
        ...
        <aside className={cn(
            ...
            <nav className="flex-1 px-6 space-y-1.5 overflow-y-auto custom-scrollbar">
                ...
                <div className="pt-8">
                    ...
                    <Link
                        href={`/registrar?${TOUR_QUERY_PARAM}=1`}
