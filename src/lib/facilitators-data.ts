...
export const FACILITATORS: Facilitator[] = [
    ...
    {
        slug: 'charles-ndubueze-nwonu',
        name: 'Chief Charles Ndubueze Nwonu',
        postNominals: 'FCA',
        title: 'Facilitator – Event Management & Institutional Systems',
        photo: '/facilitators/charles-ndubueze-nwonu.jpeg',
        bio: [
            'Chief Charles Ndubueze Nwonu, FCA, is an accomplished corporate executive, financial strategist, and business leader with over thirty-five years of distinguished professional experience spanning accounting, corporate governance, logistics management, infrastructure development, event management, procurement, and strategic business leadership.',
            'He serves as the Chairman, Executive Director, and Co-Founder of Nwando’s Signature Events Limited, one of Nigeria’s leading luxury event management companies, where he provides strategic leadership in corporate governance, financial management, infrastructure planning, supply chain optimisation, and institutional development. He also leads Charles Nwonu Professionals, a business advisory practice offering financial advisory, corporate governance, risk management, accounting consultancy, and organisational development services.',
            'Renowned for combining financial discipline with operational excellence, Chief Nwonu has been instrumental in building systems that enable the successful execution of large-scale, high-profile events while maintaining the highest standards of accountability, quality assurance, and organisational sustainability. During more than a decade with MTN Nigeria and MTN South Africa, he led complex logistics and supply chain operations, contributing to operational efficiency across regional distribution and infrastructure networks.',
            'A Fellow of the Institute of Chartered Accountants of Nigeria (FCA), his public and community leadership includes service as Member of the Nibo Electoral Committee and as former President of the Nibo Union Lagos Branch (2012–2017), where he championed community infrastructure rehabilitation and development initiatives. In recognition of his contributions to community development and humanitarian service, he was honoured with the traditional title of "Omeluora."',
            'His professional contributions have earned wide recognition, including the GAH Awards for Corporate Excellence & Luxury Design (2023 & 2024), the PYNE Awards for Hospitality & Event Sector Leadership (2018 & 2023), The Intellect Award for Innovative Entrepreneurship (2019), and the Yellow Star Award from MTN Nigeria for Corporate Operational Excellence.',
            'At Ashford & Gray Fusion Academy (AGFA), he serves as Facilitator for Event Management and Institutional Systems, where he brings extensive executive experience in organisational systems, operational planning, governance, logistics, and institutional leadership to enrich the learning experience of aspiring professionals. His philosophy centres on building sustainable systems that promote efficiency, accountability, operational excellence, and long-term institutional success.',
        ],
        expertise: [
            ...
            'Business Strategy & Organisational Development',
        ],
    },
    {
    ...
    },
    {
        ...
        bio: [
            ...
            'At Ashford & Gray Fusion Academy (AGFA), Dr. Emmanuel Iruayenama serves as a Facilitator in Hospitality Workforce Management, where he combines extensive industry experience with academic excellence to prepare learners for effective people management, productive industrial relations, ethical leadership, and sustainable organizational success.',
        ],
    },
    {
