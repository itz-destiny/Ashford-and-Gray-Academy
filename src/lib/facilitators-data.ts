...
export const FACILITATORS: Facilitator[] = [
    ...
    {
        slug: 'steve-iyke-onyebuchi',
        name: 'Mr. Steve Iyke Onyebuchi',
        title: 'Facilitator – Event Management & Institutional Systems',
        photo: '/facilitators/steve-iyke-onyebuchi.png',
        bio: [
            'Mr Steve Iyke Onyebuchi is a seasoned event management professional, educator and brand strategist with over 16 years of experience in the luxury events industry.',
            'As Chief Executive Officer of GrandLuxe Events Ltd, he leads a premium event-planning, design and decoration company recognised for creating exceptional experiences for corporate organisations, SMEs and private clients. His work combines creativity, precision and strategic brand presentation.',
            'He is also a thought leader, speaker and teacher committed to developing professionals who possess both technical competence and strong character. As President of the Steve Iyke Foundation, he advances youth empowerment through leadership, entrepreneurship and personal-development initiatives.',
            'His areas of expertise include Event Planning and Management, Luxury Event Design and Décor, Brand Experience, and Event Entrepreneurship. His teaching approach combines practical case studies, industry best practices and mentorship, equipping students for sustainable and successful careers in the events industry.',
            'Mr Steve joins Ashford & Gray Fusion Academy with a commitment to bridging the gap between industry and academia—developing graduates who are not only certified, but genuinely job-ready, business-ready and brand-ready.',
            'Core Belief: "Dreams come through with consistency. Excellence is a habit."',
        ],
        expertise: [
            'Event Planning & Management',
            'Luxury Event Design & Décor',
