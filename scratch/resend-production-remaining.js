...
async function main() {
  ...
  const csvLines = ['email,temporaryPassword'];
  ...
  // Write CSV of temp passwords
  fs.writeFileSync(path.join(__dirname, 'temp-passwords.csv'), csvLines.join('\n'));
  console.log('Wrote scratch/temp-passwords.csv');
